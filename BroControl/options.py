...
options = [
    ...
    Option("SitePolicyManager", "", "string", Option.USER, False,
           "Space-separated list of local policy files for manager.  This option is deprecated."),
    Option("SitePolicyLogger", "", "string", Option.USER, False,
           "Space-separated list of local policy files for logger.  This option is deprecated."),
    Option("SitePolicyProxy", "", "string", Option.USER, False,
           "Space-separated list of local policy files for proxy.  This option is deprecated."),
    Option("SitePolicyWorker", "", "string", Option.USER, False,
           "Space-separated list of local policy files for workers.  This option is deprecated."),
    Option("SitePolicyStandalone", "", "string", Option.USER, False,
